export const htmlEmail = ({ name, date, time, address, status }) => `
<div style="font-family: Poppins, sans-serif; color: #333; line-height: 1.5; width: 90%; margin: 0 auto; padding: 20px; border: 1px solid #e2e2e2; border-radius: 8px; background-color: #f9f9f9;">
  ...
  <h2 style="margin-top: 10px;">
    Thank you <span style="color: green; font-weight: bold;">${name}</span>, your application has been successfully <span style="font-weight: bold;">added / updated</span>.
  </h2>

  <h3 style="margin-top: 20px; margin-bottom: 15px; color: #1D4ED8;">Application Details</h3>
